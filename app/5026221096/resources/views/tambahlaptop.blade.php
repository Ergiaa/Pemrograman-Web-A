...
@section('headerPage', 'Tambah Data Laptop')
    ...
    <div class="card p-4">
        <form action="/laptop/store" method="POST">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="merklaptop" id="merklaptop" class="form-control" required="required" placeholder="Masukkan merk laptop">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" name="stocklaptop" id="stocklaptop" class="form-control" required="required" placeholder="Masukkan jumlah stock">
                </div>
            </div>
